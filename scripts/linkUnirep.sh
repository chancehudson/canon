...
ln -s $1/packages/utils/build $(pwd)/packages/relay/node_modules/@unirep/utils
...
ln -s $1/packages/utils/build $(pwd)/packages/frontend/node_modules/@unirep/utils
...
ln -s $1/packages/utils/build $(pwd)/packages/contracts/node_modules/@unirep/utils
